...
export class PaymentService {
  ...
  static async createDeposit(params: {
    ...
    if (amount < 100) throw new Error('Minimum deposit is Ksh 100')
    if (amount > 100000) throw new Error('Maximum deposit is Ksh 1,00,000')
  ...
  static async createWithdrawal(params: {
    ...
    if (amount < 500) throw new Error('Minimum withdrawal is Ksh 500')
    if (amount > 50000) throw new Error('Maximum withdrawal per request is Ksh 50,000')
