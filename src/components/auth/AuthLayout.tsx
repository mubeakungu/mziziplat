      ...
      <div className="hidden lg:flex w-1/2 relative z-10 flex-col justify-between p-12 bg-white/5 backdrop-blur-sm border-r border-white/5">
        <div className="relative z-10">
          ...
          <div className="mt-20">
             ...
             >
                 Join Kenya&apos;s most transparent betting platform. Instant M-Pesa withdrawals, verified fairness, and daily rewards wait for you.
             </motion.p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 relative z-10">
            <div className="p-4 rounded-2xl bg-black/40 border border-white/5 backdrop-blur-md">
                ...
                <p className="text-xs text-gray-500">Every roll cryptographically verifiable</p>
            </div>
            <div className="p-4 rounded-2xl bg-black/40 border border-white/5 backdrop-blur-md">
        ...
        <div className="w-full max-w-md space-y-8">
            <div className="lg:hidden text-center mb-8">
                <Link href="/" className="inline-flex items-center space-x-2">
                    ...
                    <span className="text-2xl font-bold font-heading text-white">MZIZIBET</span>
                </Link>
            </div>
            ...
            >
                {/* Top decorative line */}
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary via-orange-500 to-amber-600" />
