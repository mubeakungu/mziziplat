...
const features = [
  ...
  },
  {
    ...
    description: 'Your funds are protected by enterprise-grade encryption and mandatory 2FA for withdrawals.',
    icon: Lock,
    color: 'text-red-400',
    bg: 'bg-red-500/10',
  },
    ...
    <section className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            The Ultimate <span className="text-gradient-gold">Betting &amp; Casino</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
