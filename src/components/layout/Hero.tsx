...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Background layers */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-900/20 via-background to-background opacity-70 z-0 pointer-events-none"></div>
      ...
      <div className="container relative z-10 flex flex-col items-center gap-8 text-center mx-auto px-4 perspective-1000">
        ...
        >
            ...
            >
                ...
                <span className="tracking-wider uppercase text-xs font-bold">Kenya's Home for Fair Play</span>
            </motion.div>
            ...
            >
                ...
                <span className="text-gradient-gold inline-block mt-2">Betting &amp; Casino</span>
            </motion.h1>
            ...
            >
                Experience the thrill of next-gen betting. Instant M-Pesa payouts, transparent odds, and <span className="text-white font-semibold text-gradient-gold">100% fair games</span> you can verify yourself.
            </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 text-center text-sm">Instant M-Pesa deposits &amp; withdrawals</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-400 text-center text-sm">Every result verifiable by you</p>
          </motion.div>
          ...
          <motion.div 
             ...
             className="flex flex-col items-center gap-4 p-6 rounded-2xl glass-card hover:bg-white/10 transition-all duration-300 group"
           >
            <div className="p-3 rounded-full bg-gradient-to-br from-amber-500/20 to-pink-500/20 group-hover:from-amber-500/30 group-hover:to-pink-500/30 transition-all">
              <Coins className="h-8 w-8 text-amber-400 group-hover:animate-pulse" />
            </div>
