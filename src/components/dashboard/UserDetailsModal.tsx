            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="bg-white/5 border-white/10">
                <CardContent className="p-4 flex flex-col gap-2">
                  ...
                  <div className="flex items-end gap-2 text-green-400">
                    ...
                    <span className="text-xl font-bold">Ksh {user.mainBalance.toFixed(2)}</span>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-white/5 border-white/10">
                <CardContent className="p-4 flex flex-col gap-2">
                  ...
                  <div className="flex items-end gap-2 text-amber-400">
                    ...
                    <span className="text-xl font-bold">Ksh {user.bonusBalance.toFixed(2)}</span>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-white/5 border-white/10">
             ...
             <div className="grid grid-cols-1 gap-4">
                <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20 text-center">
                    ...
                    <p className="text-lg font-bold text-blue-400">Ksh {user.totalWagered?.toFixed(2) || '0.00'}</p>
                </div>
             </div>
          </TabsContent>
