    ...
    <div className="flex flex-col items-center justify-center p-4">
      <Card className="w-full max-w-4xl glass-card border-white/10 bg-black/40">
        ...
        <CardContent className="space-y-8 min-h-[300px]">
            ...
            {message && <div className="text-center text-xl font-bold text-emerald-300 animate-pulse">{message}</div>}
             ...
             <div className="flex w-full gap-4 items-end">
                <div className="space-y-2 flex-1">
                    ...
                    <Input
                        ...
                        min={1}
                        className="bg-black/50 border-white/10 focus:border-emerald-500/50 text-white"
                        disabled={gameState !== "idle"}
                    />
                </div>
                {gameState === "idle" ? (
                    <Button onClick={startDeal} className="flex-1 h-12 bg-emerald-600 hover:bg-emerald-700 font-bold text-lg">
                        DEAL
                    </Button>
                ) : (
