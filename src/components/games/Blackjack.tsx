    ...
    return (
        ...
        >
            ...
            {/* Back of card (visible when hidden is true due to rotateY) */}
             <div 
                className={`absolute inset-0 backface-hidden w-full h-full rounded-xl bg-linear-to-br from-emerald-600 to-blue-900 flex items-center justify-center border-2 border-emerald-400`}
