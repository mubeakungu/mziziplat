                              ...
                              >
                                {isActive && (
                                  <motion.div
                                    ...
                                    className="absolute inset-0 bg-gradient-to-r from-primary/20 to-amber-500/20 rounded-xl blur-sm"
                                    transition={{ type: "spring", stiffness: 500, damping: 30 }}
                                  />
                                )}
                                <div className={`relative flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ${
                                  isActive
                                    ? 'bg-gradient-to-r from-primary to-amber-600 text-white shadow-[0_0_20px_rgba(102,126,234,0.4)]'
          ...
          <div className="mt-8 pt-6 border-t border-white/10 space-y-4">
             ...
             {session?.user && (
              <Link href="/profile" className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all group border border-white/10 hover:border-primary/30">
                <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-primary to-amber-500 p-[2px]">
