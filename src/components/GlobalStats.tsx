...
const stats = [
  { label: 'Total Wagered', value: 'Ksh 48,294,000+', icon: Coins, color: 'text-yellow-400' },
  { label: 'Active Players', value: '1,240+', icon: Users, color: 'text-blue-400' },
  { label: 'Total Payouts', value: 'Ksh 32,105,000+', icon: Trophy, color: 'text-green-400' },
  { label: 'Bets Placed', value: '850,000+', icon: Zap, color: 'text-amber-400' },
]
