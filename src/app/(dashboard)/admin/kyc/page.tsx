...
export default function AdminKYCPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-amber-900/20 to-gray-900 p-6 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-amber-900/20 to-gray-900 p-6">
