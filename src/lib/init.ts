  ...
  const settings = [
    {
      key: 'MIN_DEPOSIT',
      value: 100,
      description: 'Minimum deposit amount in Ksh ',
    },
    {
      key: 'MAX_DEPOSIT',
      value: 100000,
      description: 'Maximum deposit amount in Ksh ',
    },
    {
      key: 'MIN_WITHDRAWAL',
      value: 500,
      description: 'Minimum withdrawal amount in Ksh ',
    },
    {
      key: 'MAX_WITHDRAWAL',
      value: 50000,
      description: 'Maximum withdrawal amount per request in Ksh ',
    },
    {
    ...
    },
    {
      ...
      value: 10,
      description: 'Minimum withdrawal fee in Ksh ',
    },
    {
      key: 'SIGNUP_BONUS',
      value: 100,
      description: 'Signup bonus amount in Ksh ',
    },
    {
      key: 'DAILY_REWARD',
      value: 10,
      description: 'Daily reward amount in Ksh ',
    },
  ]
